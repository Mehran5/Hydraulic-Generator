...
<body class="home">
    ...
    <div class="color-bar-1" style="padding: 0.1px;">
     <h5 align="center" >Hydraulic Generator Technical Information - Hydraulic Generators for installation into existing hydraulic circuits</h5>   
    </div>
    <div class="container">
    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        ================================================== -->
        <div class="span9">
            <div class="span" style="padding: 10px 0px 0px 10px;">
                <img src="img/new/Z62.jpg">
            </div>
            <div class="span" style="padding: 10px 0px 0px 80px;">
                <img src="img/new/Z63.jpg">
            </div>
        </div>
        ...
        <div class="span10" style="">
            <table class="table table-striped">
                <thead>
                  <tr>
                    <th><h3 align="center">Hydraulic Generators Installation</h3></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>Are you looking for a Hydraulic Generator and put off at the thought of having to install it?</td>
                  </tr>      
                  <tr class="info">
                    <td>Take a look at the video below and you might just find it’s easier than you think.</td>
                  </tr>
                  <tr>
                    <td>With 1000’s of machines now installed around the world on machinery and equipment including boats, barges, scissor lifts, booms, trucks, vans, cranes, planes and excavators to name but a few.</td>
                  </tr>
                  <tr class="info">
                    <td>Our hydraulic generator is designed to make installation as simple as possible all the main components are integrated into our manifold, in most instances you simply need to connect your hydraulic hoses and a 12vdc supply and you’re ready to run.</td>
                  </tr>
                </tbody>
            </table>
        </div>
        <div class="span9">
            <iframe width="967" height="500" src="https://youtube.com/embed/r98GoYeOZy4">
            </iframe>
